...
import { toggleFeeSelectModal, getExpenseBillingGroupFees, toggleFeesWriteInModal } from 'common/reducers/tmsExpense';
...
@connect(
  state => ({
    visible: state.tmsExpense.feeCatModal.visible,
    feeCats: state.tmsExpense.feeCatModal.feeCats,
  }),
